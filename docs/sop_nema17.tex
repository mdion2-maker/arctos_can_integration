...
\begin{itemize}[leftmargin=*]
    \item \textbf{Speed at or below 225} (motor rpm). Above $\approx$250 the motor
          receives more pulses than it executes and silently loses position. It
          saturates near 310~rpm.
