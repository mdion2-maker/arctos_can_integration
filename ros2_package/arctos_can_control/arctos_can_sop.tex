...
\section{Session Log: Joint A -- CAN Confirmed, Bare-Motor Exoneration, and Two Script Bugs Found}
...
\section{Session Log: Joint A Belt-Coupled Verification (2026-08-31, continued)}
...
\section{Session Log: Joint B -- Interrupted Calibration, a Runaway-Looking Symptom, and Recovery}
...
\section{Session Log: A Real Runaway, Traced to an Absolute-Position Encoding Bug, Not the Gearbox}
...
\section{Session Log: Joint B Real-Load Verification, After Re-Establishing a Safe Envelope by Hand}
...
\section{Session Log: Joint Z Bring-Up (Bare Motor)}
...
\section{Session Log: Joint Z Real-Load Testing -- A Chain of Apparent Mechanical Problems, All Traced to One Test-Script Bug}
