...
\begin{itemize}
    ...
    \item Establish which direction byte (\texttt{0x00} vs \texttt{0x80})
    corresponds to clockwise at this joint --- it was never confirmed visually,
    and \texttt{C\_joint} carries \texttt{inverted: true} in
    \texttt{arctos\_controller.yaml}.
